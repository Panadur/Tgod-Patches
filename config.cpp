...
class CfgExileCustomCode 
{
	...
	*/
	ExileClient_object_construction_upgradeShow = "panadur\ExileClient_object_construction_upgradeShow.sqf";
	ExileClient_object_construction_upgrade = "panadur\ExileClient_object_construction_upgrade.sqf";
